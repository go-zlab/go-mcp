...
To integrate with a real LLM service (OpenAI, Anthropic, etc.), replace the `MockSamplingHandler` with an implementation that calls your preferred LLM API. See the [client sampling documentation](https://go-mcp.dev/clients/advanced-sampling) for examples with real LLM providers.
